...
<div class="alert-container">
    ...
    <div class="alert fade in out alert-warning alert-dismissible" role="alert">
        ...
        <strong>�ATENCI�N!.</strong> En la Base de Datos se han encontrado carnets sin imprimir. Puedes <a class="alert-link" href="#" onclick="callServer('ListarSocios', 'aviso')">'LISTAR'</a> o <a target="_blank" class="alert-link" href="../GestorImpresionCarnets?imprimir=all">'IMPRIMIR'</a>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">Busqueda de Socios</h3>
    </div>
            ...
            <div class="form-group container-fluid">
                <div class="col-sm-3 col-md-3 col-lg-3">
                    <select class="form-control" name="busqueda" onchange="activaForm();" id="selector-busqueda">
                        ...
                        <option value="numero">N�mero de socio</option>
                        <option value="rango">Rango de socios</option>
                ...
                <div class="col-sm-2 col-md-2 col-lg-2">
                    <button class="btn btn-primary btn-block" type="button" onclick="callServer('ListarSocios', 'busqueda')">Buscar</button>
                </div>
            </div>
        </form>
    </div>
