...
<div class="alert-container">
    ...
    <div class="alert fade in out alert-warning alert-dismissible" role="alert">
        ...
        <strong>¡ATENCIÓN!.</strong> En la Base de Datos se han encontrado carnets sin imprimir. Puedes <a class="alert-link" href="#" onclick="callServer('ListarAlumnos', 'aviso')">'LISTAR'</a> o <a target="_blank" class="alert-link" href="../GestorImpresionCarnets?imprimir=all">'IMPRIMIR'</a>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">Busqueda de Alumnos</h3>
    </div>
            ...
            <div class="form-group container-fluid">
                <div class="col-sm-3 col-md-3 col-lg-3">
                    <select class="form-control" name="busqueda" onchange="activaForm();" id="selector-busqueda">
                        ...
                        <option value="numero">Número de alumno</option>
                        <option value="rango">Rango de alumnos</option>
                ...
                <div class="col-sm-3 col-md-3 col-lg-3">
                    <div class="col-sm-5 col-md-5 col-lg-5">
                        <input disabled class="form-control" type="text" name="param2" id="param2" placeholder="Nº"/>
                    </div>
                    <div class="col-sm-2 col-md-2 col-lg-2" style="text-align: center;">
                        <label class="control-label">AL</label>
                    </div>
                    <div class="col-sm-5 col-md-5 col-lg-5">
                        <input disabled class="form-control" type="text" name="param3" id="param3" placeholder="Nº"/>
                    </div>
                </div>
                <div class="col-sm-2 col-md-2 col-lg-2">
                    <button class="btn btn-primary btn-block" type="button" onclick="callServer('ListarAlumnos', 'busqueda')">Buscar</button>
                </div>
            </div>
        </form>
    </div>
</div>
<table class="table table-hover listaSocios">
