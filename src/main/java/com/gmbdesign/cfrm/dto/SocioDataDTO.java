...
public class SocioDataDTO {
    ...
    public SocioDataDTO(String nombre, String primerApellido, String segundoApellido, String dni, String nacimiento, String alta, String correo, String telefono, String direccion, String codigoPostal, String ciudad, String iban) {
        this.nombre = nombre;
    ...
    public String getIban() {
        return arrayToString(this.iban);
    }

    public void setIban(String iban) {
        this.iban = iban.split("/");
    }
