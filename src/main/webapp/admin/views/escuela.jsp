        ...
        <div class="tab-nav">
            <ul class="nav nav-tabs nav-justified" role="tablist">
                <li role="presentation" class="active">
                    <a href="#registro" aria-controls="registro" role="tab" data-toggle="tab" aria-expanded="true">Nuevo Alumno</a>
                </li>
                <li role="presentation">
                    <a href="#listado" aria-controls="listado" role="tab" data-toggle="tab" aria-expanded='false'>Listar Alumnos</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div role="tabpanel" class="tab-pane active" id="registro"> 
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form class="form-horizontal" id="alumno">
                        <div class="form-group container-fluid" id="form-user">
                            <label for="socio" class="col-sm-2 col-md-2 col-lg-2 control-label">Número de Socio:</label>
                            ...
                            <label for="usuario" class="col-sm-2 col-md-2 col-lg-2 control-label">Código sistema:</label>
                        ...
                        <div class="form-group container-fluid">
                            ...
                            <label for="phone" class="col-sm-2 col-md-2 col-lg-2 control-label">Teléfono:</label>
                            <div class="col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="form-group container-fluid">
                            <label for="direccion" class="col-sm-2 col-md-2 col-lg-2 control-label">Dirección:</label>
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <input type="text" name="datos[direccion][]" class="form-control" id="direccion" aria-describedby="inputSuccess2Status">
                            </div>
                            <div class="col-sm-2 col-md-2 col-lg-2">
                                <input type="text" name="datos[direccion][]" placeholder="Nº" class="form-control" id="numero" aria-describedby="inputSuccess2Status">
                            </div>
                            <div class="col-sm-2 col-md-2 col-lg-2">
                        ...
                        <div class="form-group container-fluid">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4">
                                <button onclick="callServerWithValidation('RegistroAlumno', 'alumno')" type="button" class="btn btn-primary btn-lg btn-block" id="form-sub" >Registrar Socio en el sistema</button>
                            </div>
                        </div>    
