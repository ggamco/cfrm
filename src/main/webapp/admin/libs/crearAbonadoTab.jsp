...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-horizontal" id="abonado">
            <div class="form-group container-fluid" id="form-user">
                <label for="abonado" class="col-sm-2 col-md-2 col-lg-2 control-label">N�mero de Abonado:</label>
                <div class="col-sm-2 col-md-2 col-lg-">
                    <input type="number" name="numeroAbonado" value="<%=numero%>" class="form-control" id="abonado" aria-describedby="inputSuccess2Status">
                </div>
                <div class="col-sm-2 col-md-2 col-lg-">
            ...
            <div class="form-group container-fluid">
                <label for="grada" class="col-sm-2 col-md-2 col-lg-2 control-label">Grada</label>
                <div class="col-sm-4 col-md-4 col-lg-4">
                    <select name="grada" id="grada" class="form-control" aria-describedby="inputSuccess2Status">
                        <option disabled selected>-</option>
                        <option value=""></option>
                    </select>
                </div>
                <div class="col-sm-2 col-md-2 col-lg-2">
                    <select name="sector" class="form-control" aria-describedby="inputSuccess2Status">
                        <option disabled selected>Sector</option>
                        <option value=""></option>
                    </select>
                </div>
                <div class="col-sm-2 col-md-2 col-lg-2">
                    <select name="fila" class="form-control" aria-describedby="inputSuccess2Status">
                        <option disabled selected>Fila</option>
                        <option value=""></option>
                    </select>
                </div>
                <div class="col-sm-2 col-md-2 col-lg-2">
                    <select name="asiento" class="form-control" aria-describedby="inputSuccess2Status">
                        <option disabled selected>Asiento</option>
                        <option value=""></option>
                    </select>
                </div>
            </div>
            <div class="form-group container-fluid">
                ...
                <div class="col-sm-4 col-md-4 col-lg-4">
                    <button onclick="callServerWithValidation('RegistroAbonados', 'abonado')" type="button" class="btn btn-primary btn-lg btn-block" id="form-sub" >Registrar Abonado en el sistema</button>
                </div>
            </div>
